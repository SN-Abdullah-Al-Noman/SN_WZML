...
START_MEDIA = "https://telegra.ph/file/7d9bbdb63e723eb25ea9.png" #replace your image
    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_photo(START_MEDIA,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("How to use me❓", url='https://t.me/'),                  
                    ],
                    [
                        InlineKeyboardButton("Get api 🔗", url='https://site.in/member/tools/api'),
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),                   
                    ],
                    [
                        InlineKeyboardButton("help", callback_data="helptxt"),
...
@Bot.on_message((filters.document | filters.photo | filters.sticker | filters.video | filters.audio) & ~filters.chat(Config.DB_CHANNEL))
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact Me [ Admin BOT ](https://telegram.me/adminbot)",
                                     disable_web_page_preview=True)
            return
...
async def api_handler(bot, m):
    user_id = m.from_user.id

    user = await db.get_user(user_id)
    cmd = m.command
    if len(cmd) == 1:
        API_MESSAGE = "To add or update your Shortner Website API,\n\n To get your api visit: https://site.in/member/tools/api \n\nEx: `/api 5d9603650f2b1fd15f543acb1fb0a0764403ba5c`\n\nCurrent Shortener API: `{shortener_api}`"
        s = API_MESSAGE.format(shortener_api=user["shortener_api"])
...
async def button(bot: Client, cmd: CallbackQuery):
    ...
    if "aboutbot" in cb_data:
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact me [ Admin BOT ](https://t.me/adminbot).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact me [ Admin BOT ](https://t.me/adminbot).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
        ...
        await cmd.message.edit("File Saved in Batch Successfully ✅\n\n"
        ...
        if message_ids is None:
            ...
            return
        await cmd.message.edit("Please wait, generating a Batch link🕒...")
